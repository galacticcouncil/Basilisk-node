...
pub use primitives::{fee::Fee, Amount, AssetId, Balance};
use sp_runtime::{
	generic,
...
// pallet xyk
parameter_types! {
	pub ExchangeFee: Fee = Fee {numerator: 2, denominator: 1_000};
...
// pallet lbp
parameter_types! {
	pub LBPExchangeFee: Fee = Fee {numerator: 2, denominator: 1_000};
}
