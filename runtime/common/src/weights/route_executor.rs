...
impl<T: frame_system::Config> WeightInfo for BasiliskWeight<T> {
	fn execute_sell(n: u32) -> Weight {
		(15_367_000 as Weight) // Standard Error: 137_000
			.saturating_add((81_706_000 as Weight).saturating_mul(n as Weight))
	...
	fn execute_buy(n: u32) -> Weight {
		(11_850_000 as Weight) // Standard Error: 153_000
			.saturating_add((81_042_000 as Weight).saturating_mul(n as Weight))
			.saturating_add(T::DbWeight::get().reads(2 as Weight))
			.saturating_add(T::DbWeight::get().reads((8 as Weight).saturating_mul(n as Weight)))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
			.saturating_add(T::DbWeight::get().writes((3 as Weight).saturating_mul(n as Weight)))
