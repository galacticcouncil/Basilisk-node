...
impl<T: frame_system::Config> WeightInfo for BasiliskWeight<T> {
    ...
    fn dust_account() -> Weight {
        ...
        Weight::from_ref_time(55_138_000 as u64)            .saturating_add(T::DbWeight::get().reads(7 as u64))
    ...
    fn remove_nondustable_account() -> Weight {
        ...
        Weight::from_ref_time(19_581_000 as u64)            .saturating_add(T::DbWeight::get().reads(1 as u64))
