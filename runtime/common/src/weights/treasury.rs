...
impl<T: frame_system::Config> WeightInfo for BasiliskWeight<T> {
    ...
    fn propose_spend() -> Weight {
        ...
        Weight::from_ref_time(16_358_000 as u64)            .saturating_add(T::DbWeight::get().reads(1 as u64))
    ...
    fn reject_proposal() -> Weight {
        ...
        Weight::from_ref_time(22_820_000 as u64)            .saturating_add(T::DbWeight::get().reads(2 as u64))
            .saturating_add(T::DbWeight::get().writes(2 as u64))
    }
    ...
    fn remove_approval() -> Weight {
        ...
        Weight::from_ref_time(6_979_000 as u64)            .saturating_add(T::DbWeight::get().reads(1 as u64))
            .saturating_add(T::DbWeight::get().writes(1 as u64))
    }
