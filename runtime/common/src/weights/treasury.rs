...
impl<T: frame_system::Config> WeightInfo for BasiliskWeight<T> {
	...
	fn propose_spend() -> Weight {
		Weight::from_ref_time(29_444_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	fn reject_proposal() -> Weight {
		Weight::from_ref_time(45_918_000 as u64)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	fn approve_proposal(p: u32) -> Weight {
		Weight::from_ref_time(11_009_000 as u64) // Standard Error: 7_000
	...
	fn on_initialize_proposals(p: u32) -> Weight {
		Weight::from_ref_time(23_873_000 as u64) // Standard Error: 53_000
			.saturating_add(Weight::from_ref_time(40_085_000 as u64).saturating_mul(p as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
