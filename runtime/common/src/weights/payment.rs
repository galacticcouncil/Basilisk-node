...
impl<T: frame_system::Config> WeightInfo for BasiliskWeight<T> {
    ...
    fn add_currency() -> Weight {
        ...
        Weight::from_ref_time(18_000_000 as u64)            .saturating_add(T::DbWeight::get().reads(1 as u64))
    ...
    fn remove_currency() -> Weight {
        ...
        Weight::from_ref_time(18_777_000 as u64)            .saturating_add(T::DbWeight::get().reads(1 as u64))
            .saturating_add(T::DbWeight::get().writes(1 as u64))
    }
    ...
    fn set_currency() -> Weight {
        ...
        Weight::from_ref_time(22_029_000 as u64)            .saturating_add(T::DbWeight::get().reads(1 as u64))
            .saturating_add(T::DbWeight::get().writes(1 as u64))
    }
