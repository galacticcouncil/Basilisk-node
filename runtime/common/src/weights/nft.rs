...
impl<T: frame_system::Config> WeightInfo for BasiliskWeight<T> {
	...
	fn create_collection() -> Weight {
		// Minimum execution time: 19_545 nanoseconds.
	...
	fn mint() -> Weight {
		...
		Weight::from_ref_time(31_278_000 as u64)
	...
	// Proof: NFT Items (max_values: None, max_size: Some(122), added: 2597, mode: MaxEncodedLen)
	fn burn() -> Weight {
		// Minimum execution time: 31_519 nanoseconds.
		Weight::from_ref_time(31_942_000 as u64)
			.saturating_add(T::DbWeight::get().reads(5 as u64))
			.saturating_add(T::DbWeight::get().writes(5 as u64))
	}
}
