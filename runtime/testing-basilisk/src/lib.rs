...
use frame_support::{
	...
	traits::{EitherOfDiverse, EnsureOrigin, EqualPrivilegeOnly, Everything, Get, InstanceFilter, U128CurrencyToVote},
	weights::{
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		PriceOracle: pallet_price_oracle exclude_parts { Config } = 107,
