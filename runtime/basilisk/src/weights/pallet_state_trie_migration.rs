...
impl<T: frame_system::Config> pallet_state_trie_migration::WeightInfo for BasiliskWeight<T> {
	...
	fn continue_migrate() -> Weight {
		...
		Weight::from_parts(24_840_000, 3550)
	...
	fn continue_migrate_wrong_witness() -> Weight {
		...
		Weight::from_parts(6_418_000, 1493)
	...
	fn migrate_custom_top_success() -> Weight {
		...
		Weight::from_parts(15_238_000, 3550)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	...
	fn migrate_custom_top_fail() -> Weight {
		...
		//  Measured:  `146`
		//  Estimated: `3611`
		// Minimum execution time: 76_410_000 picoseconds.
		Weight::from_parts(77_096_000, 3611)
	...
	fn migrate_custom_child_success() -> Weight {
		...
		Weight::from_parts(15_505_000, 3550)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `Balances::Holds` (r:1 w:1)
	/// Proof: `Balances::Holds` (`max_values`: None, `max_size`: Some(85), added: 2560, mode: `MaxEncodedLen`)
	...
	fn migrate_custom_child_fail() -> Weight {
		...
		//  Measured:  `106`
		//  Estimated: `3571`
		// Minimum execution time: 77_030_000 picoseconds.
		Weight::from_parts(77_772_000, 3571)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn process_top_key(v: u32, ) -> Weight {
		...
		Weight::from_parts(6_125_000, 3727)
			// Standard Error: 1
			.saturating_add(Weight::from_parts(1_751, 0).saturating_mul(v.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
