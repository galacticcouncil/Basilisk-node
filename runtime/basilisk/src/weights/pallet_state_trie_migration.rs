...
impl<T: frame_system::Config> pallet_state_trie_migration::WeightInfo for BasiliskWeight<T> {
	...
	fn continue_migrate() -> Weight {
		...
		Weight::from_parts(27_647_000, 3604)
	...
	fn continue_migrate_wrong_witness() -> Weight {
		...
		Weight::from_parts(7_802_000, 1493)
	...
	fn migrate_custom_top_success() -> Weight {
		...
		Weight::from_parts(17_219_000, 3604)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	...
	fn migrate_custom_top_fail() -> Weight {
		...
		//  Measured:  `146`
		//  Estimated: `3611`
		// Minimum execution time: 85_920_000 picoseconds.
		Weight::from_parts(86_745_000, 3611)
	...
	fn migrate_custom_child_success() -> Weight {
		...
		Weight::from_parts(17_685_000, 3604)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `Balances::Holds` (r:1 w:1)
	/// Proof: `Balances::Holds` (`max_values`: None, `max_size`: Some(139), added: 2614, mode: `MaxEncodedLen`)
	...
	fn migrate_custom_child_fail() -> Weight {
		...
		//  Measured:  `106`
		//  Estimated: `3604`
		// Minimum execution time: 86_311_000 picoseconds.
		Weight::from_parts(86_815_000, 3604)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn process_top_key(v: u32, ) -> Weight {
		...
		Weight::from_parts(8_231_000, 3727)
			// Standard Error: 6
			.saturating_add(Weight::from_parts(1_926, 0).saturating_mul(v.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
