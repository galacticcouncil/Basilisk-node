...
impl<T: frame_system::Config> pallet_state_trie_migration::WeightInfo for BasiliskWeight<T> {
	...
	fn continue_migrate() -> Weight {
		...
		Weight::from_parts(33_797_000, 3622)
	...
	fn continue_migrate_wrong_witness() -> Weight {
		...
		Weight::from_parts(11_282_000, 1493)
	...
	fn migrate_custom_top_success() -> Weight {
		...
		Weight::from_parts(21_202_000, 3622)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	...
	fn migrate_custom_top_fail() -> Weight {
		...
		//  Measured:  `146`
		//  Estimated: `3622`
		// Minimum execution time: 110_974_000 picoseconds.
		Weight::from_parts(113_046_000, 3622)
	...
	fn migrate_custom_child_success() -> Weight {
		...
		Weight::from_parts(21_624_000, 3622)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `Balances::Holds` (r:1 w:1)
	/// Proof: `Balances::Holds` (`max_values`: None, `max_size`: Some(157), added: 2632, mode: `MaxEncodedLen`)
	...
	fn migrate_custom_child_fail() -> Weight {
		...
		//  Measured:  `106`
		//  Estimated: `3622`
		// Minimum execution time: 108_472_000 picoseconds.
		Weight::from_parts(110_722_000, 3622)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn process_top_key(v: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `262 + v * (1 ±0)`
		//  Estimated: `3727 + v * (1 ±0)`
		// Minimum execution time: 10_250_000 picoseconds.
		Weight::from_parts(10_563_000, 3727)
			// Standard Error: 1
			.saturating_add(Weight::from_parts(1_269, 0).saturating_mul(v.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
