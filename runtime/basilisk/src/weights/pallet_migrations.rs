...
// --output
// runtime/hydradx/src/weights/pallet_migrations.rs
// --quiet
...
/// Weights for `pallet_migrations` using the HydraDX node and recommended hardware.
...
impl<T: frame_system::Config> pallet_migrations::WeightInfo for BasiliskWeight<T> {
    ...
    fn onboard_new_mbms() -> Weight {
        ...
        Weight::from_parts(12_477_000, 67035)
    ...
    fn progress_mbms_none() -> Weight {
        ...
        Weight::from_parts(3_675_000, 67035)
    ...
    fn exec_migration_completed() -> Weight {
        ...
        //  Measured:  `233`
        //  Estimated: `3698`
        // Minimum execution time: 9_734_000 picoseconds.
        Weight::from_parts(10_029_000, 3698)
            .saturating_add(T::DbWeight::get().reads(1_u64))
            .saturating_add(T::DbWeight::get().writes(1_u64))
    }
    /// Storage: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
    ...
    fn exec_migration_skipped_historic() -> Weight {
        ...
        Weight::from_parts(17_630_000, 3894)
            .saturating_add(T::DbWeight::get().reads(2_u64))
    }
    /// Storage: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
    /// Proof: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
    ...
    fn exec_migration_advance() -> Weight {
        ...
        Weight::from_parts(16_996_000, 3840)
            .saturating_add(T::DbWeight::get().reads(2_u64))
    }
    /// Storage: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
    /// Proof: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
    ...
    fn exec_migration_complete() -> Weight {
        ...
        Weight::from_parts(19_330_000, 3840)
            .saturating_add(T::DbWeight::get().reads(2_u64))
            .saturating_add(T::DbWeight::get().writes(1_u64))
    }
    /// Storage: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
    ...
    fn exec_migration_fail() -> Weight {
        ...
        //  Measured:  `375`
        //  Estimated: `3840`
        // Minimum execution time: 44_522_000 picoseconds.
        Weight::from_parts(44_960_000, 3840)
            .saturating_add(T::DbWeight::get().reads(2_u64))
            .saturating_add(T::DbWeight::get().writes(1_u64))
    }
    ...
    fn force_onboard_mbms() -> Weight {
        ...
        Weight::from_parts(10_288_000, 67035)
            .saturating_add(T::DbWeight::get().reads(2_u64))
    }
    ...
    fn clear_historic(n: u32, ) -> Weight {
        ...
        Weight::from_parts(17_298_431, 3834)
            // Standard Error: 2_141
            .saturating_add(Weight::from_parts(1_248_101, 0).saturating_mul(n.into()))
            .saturating_add(T::DbWeight::get().reads(1_u64))
    ...
    fn reset_pallet_migration(n: u32, ) -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `1709 + n * (38 ±0)`
        //  Estimated: `787 + n * (39 ±0)`
        // Minimum execution time: 2_882_000 picoseconds.
        Weight::from_parts(22_967_431, 787)
            // Standard Error: 1_617
            .saturating_add(Weight::from_parts(733_697, 0).saturating_mul(n.into()))
            .saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
