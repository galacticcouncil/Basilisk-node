...
impl<T: frame_system::Config> pallet_migrations::WeightInfo for BasiliskWeight<T> {
	...
	fn onboard_new_mbms() -> Weight {
		...
		Weight::from_parts(14_588_000, 67035)
	...
	fn progress_mbms_none() -> Weight {
		...
		Weight::from_parts(5_173_000, 67035)
	...
	fn exec_migration_completed() -> Weight {
		...
		Weight::from_parts(10_644_000, 3594)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
	...
	fn exec_migration_skipped_historic() -> Weight {
		...
		Weight::from_parts(19_718_000, 3757)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	/// Storage: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
	/// Proof: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
	...
	fn exec_migration_advance() -> Weight {
		...
		Weight::from_parts(19_349_000, 3731)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	/// Storage: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
	/// Proof: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
	...
	fn exec_migration_complete() -> Weight {
		...
		Weight::from_parts(22_091_000, 3731)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
	...
	fn exec_migration_fail() -> Weight {
		...
		Weight::from_parts(31_090_000, 3731)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn force_onboard_mbms() -> Weight {
		...
		Weight::from_parts(12_543_000, 67035)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	...
	fn clear_historic(n: u32, ) -> Weight {
		...
		Weight::from_parts(20_809_550, 3834)
			// Standard Error: 1_447
			.saturating_add(Weight::from_parts(1_386_328, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn reset_pallet_migration(n: u32, ) -> Weight {
		...
		Weight::from_parts(28_913_583, 754)
			// Standard Error: 1_271
			.saturating_add(Weight::from_parts(794_885, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
