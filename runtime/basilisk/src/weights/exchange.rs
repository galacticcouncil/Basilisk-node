...
impl<T: frame_system::Config> WeightInfo for BasiliskWeight<T> {
	fn known_overhead_for_on_finalize() -> Weight {
		(9_868_000 as Weight).saturating_add(T::DbWeight::get().reads(1 as Weight))
	}
	fn sell_intention() -> Weight {
		(91_633_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(6 as Weight))
			.saturating_add(T::DbWeight::get().writes(2 as Weight))
	}
	fn buy_intention() -> Weight {
		(93_242_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(6 as Weight))
			.saturating_add(T::DbWeight::get().writes(2 as Weight))
	}
	fn on_finalize(t: u32) -> Weight {
		(0 as Weight) // Standard Error: 69_000
			.saturating_add((64_897_000 as Weight).saturating_mul(t as Weight))
	...
	fn on_finalize_buys_no_matches(t: u32) -> Weight {
		(1_639_000 as Weight) // Standard Error: 79_000
			.saturating_add((116_783_000 as Weight).saturating_mul(t as Weight))
			.saturating_add(T::DbWeight::get().reads(6 as Weight))
	...
	fn on_finalize_sells_no_matches(t: u32) -> Weight {
		(0 as Weight) // Standard Error: 87_000
			.saturating_add((107_479_000 as Weight).saturating_mul(t as Weight))
			.saturating_add(T::DbWeight::get().reads(6 as Weight))
			.saturating_add(T::DbWeight::get().reads((3 as Weight).saturating_mul(t as Weight)))
			.saturating_add(T::DbWeight::get().writes(2 as Weight))
			.saturating_add(T::DbWeight::get().writes((2 as Weight).saturating_mul(t as Weight)))
