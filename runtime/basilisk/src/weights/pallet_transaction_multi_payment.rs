...
// --output=./weights/pallet_transaction_multi_payment
...
impl<T: frame_system::Config> pallet_transaction_multi_payment::WeightInfo for BasiliskWeight<T> {
	...
	fn add_currency() -> Weight {
		...
		Weight::from_parts(11_641_000, 3493)
	...
	fn remove_currency() -> Weight {
		...
		Weight::from_parts(14_029_000, 3493)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn set_currency() -> Weight {
		...
		Weight::from_parts(20_983_000, 3493)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn get_oracle_price() -> Weight {
		...
		//  Measured:  `2619`
		//  Estimated: `27510`
		// Minimum execution time: 102_862_000 picoseconds.
		Weight::from_parts(103_528_000, 27510)
