...
impl<T: frame_system::Config> pallet_ema_oracle::WeightInfo for BasiliskWeight<T> {
	...
	fn add_oracle() -> Weight {
		...
		Weight::from_parts(21_604_000, 1966)
	...
	fn remove_oracle() -> Weight {
		...
		Weight::from_parts(52_858_000, 5926)
	...
	fn on_finalize_no_entry() -> Weight {
		...
		Weight::from_parts(5_271_000, 5926)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `EmaOracle::Accumulator` (r:1 w:1)
	/// Proof: `EmaOracle::Accumulator` (`max_values`: Some(1), `max_size`: Some(4441), added: 4936, mode: `MaxEncodedLen`)
	...
	fn on_finalize_multiple_tokens(b: u32, ) -> Weight {
		...
		// Minimum execution time: 89_651_000 picoseconds.
		Weight::from_parts(14_764_758, 5926)
			// Standard Error: 28_878
			.saturating_add(Weight::from_parts(72_684_912, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn on_trade_multiple_tokens(b: u32, ) -> Weight {
		...
		Weight::from_parts(11_293_869, 5926)
			// Standard Error: 958
			.saturating_add(Weight::from_parts(539_084, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `EmaOracle::Accumulator` (r:1 w:1)
	...
	fn on_liquidity_changed_multiple_tokens(b: u32, ) -> Weight {
		...
		Weight::from_parts(11_323_979, 5926)
			// Standard Error: 985
			.saturating_add(Weight::from_parts(539_092, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn get_entry() -> Weight {
		...
		Weight::from_parts(25_101_000, 6294)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
}