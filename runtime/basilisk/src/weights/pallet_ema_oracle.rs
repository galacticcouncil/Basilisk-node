...
impl<T: frame_system::Config> pallet_ema_oracle::WeightInfo for BasiliskWeight<T> {
	...
	fn add_oracle() -> Weight {
		...
		Weight::from_parts(14_149_000, 1966)
	...
	fn remove_oracle() -> Weight {
		...
		Weight::from_parts(45_619_000, 5926)
	...
	fn on_finalize_no_entry() -> Weight {
		...
		Weight::from_parts(821_000, 5926)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `EmaOracle::Accumulator` (r:1 w:1)
	/// Proof: `EmaOracle::Accumulator` (`max_values`: Some(1), `max_size`: Some(4441), added: 4936, mode: `MaxEncodedLen`)
	...
	fn on_finalize_multiple_tokens(b: u32, ) -> Weight {
		...
		Weight::from_parts(13_759_600, 5926)
			// Standard Error: 16_116
			.saturating_add(Weight::from_parts(68_736_239, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn on_trade_multiple_tokens(b: u32, ) -> Weight {
		...
		Weight::from_parts(7_828_077, 5926)
			// Standard Error: 2_332
			.saturating_add(Weight::from_parts(440_683, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `EmaOracle::Accumulator` (r:1 w:1)
	...
	fn on_liquidity_changed_multiple_tokens(b: u32, ) -> Weight {
		...
		Weight::from_parts(7_783_543, 5926)
			// Standard Error: 2_401
			.saturating_add(Weight::from_parts(444_870, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn get_entry() -> Weight {
		...
		Weight::from_parts(20_720_000, 6294)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
}