...
//! DATE: 2022-10-26, STEPS: 1, REPEAT: 20, LOW RANGE: [], HIGH RANGE: []
...
impl<T: frame_system::Config> WeightInfo for BasiliskWeight<T> {
	...
	fn create_yield_farm() -> Weight {
		(99_107_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(6 as Weight))
			.saturating_add(T::DbWeight::get().writes(6 as Weight))
	}
	fn update_yield_farm() -> Weight {
		(166_002_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(7 as Weight))
			.saturating_add(T::DbWeight::get().writes(5 as Weight))
	}
	fn stop_yield_farm() -> Weight {
		(160_763_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(6 as Weight))
			.saturating_add(T::DbWeight::get().writes(6 as Weight))
	}
	fn destroy_yield_farm() -> Weight {
		(76_223_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(5 as Weight))
			.saturating_add(T::DbWeight::get().writes(4 as Weight))
	}
	fn deposit_shares() -> Weight {
		(261_922_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(18 as Weight))
			.saturating_add(T::DbWeight::get().writes(13 as Weight))
	}
	fn redeposit_shares() -> Weight {
		(62_608_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(6 as Weight))
			.saturating_add(T::DbWeight::get().writes(3 as Weight))
	}
	fn claim_rewards() -> Weight {
		(194_166_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(8 as Weight))
			.saturating_add(T::DbWeight::get().writes(7 as Weight))
	}
	fn withdraw_shares() -> Weight {
		(379_574_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(19 as Weight))
			.saturating_add(T::DbWeight::get().writes(16 as Weight))
	}
	fn resume_yield_farm() -> Weight {
		(97_613_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(6 as Weight))
			.saturating_add(T::DbWeight::get().writes(5 as Weight))
	}
}
