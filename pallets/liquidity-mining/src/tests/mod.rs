...
use crate::mock::{
	...
	ALICE, AMM_POOLS, BOB, BOB_GLOBAL_FARM_TOTAL_REWARDS, BSX, BSX_ACA_AMM, BSX_ACA_SHARE_ID, BSX_DOT_AMM, BSX_DOT_ASSET_PAIR, BSX_DOT_SHARE_ID,
	BSX_ETH_AMM, BSX_ETH_ASSET_PAIR, BSX_ETH_SHARE_ID, BSX_FARM, BSX_HDX_AMM, BSX_HDX_SHARE_ID, BSX_KSM_AMM,
	BSX_KSM_ASSET_PAIR, BSX_KSM_SHARE_ID, BSX_TKN1_AMM, BSX_TKN1_ASSET_PAIR, BSX_TKN1_SHARE_ID, BSX_TKN2_AMM,
	BSX_TKN2_ASSET_PAIR, BSX_TKN2_SHARE_ID, CHARLIE, DAVE, DOT, EVE, GC, GC_FARM, HDX, INITIAL_BALANCE, KSM,
