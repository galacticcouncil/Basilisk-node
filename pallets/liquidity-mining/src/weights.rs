...
//! DATE: 2022-09-28, STEPS: 1, REPEAT: 20, LOW RANGE: [], HIGH RANGE: []
...
impl<T: frame_system::Config> WeightInfo for BasiliskWeight<T> {
	fn create_global_farm() -> Weight {
		(63_519_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(3 as Weight))
			.saturating_add(T::DbWeight::get().writes(4 as Weight))
	}
	fn update_global_farm() -> Weight {
		(74_741_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(3 as Weight))
			.saturating_add(T::DbWeight::get().writes(3 as Weight))
	}
	fn destroy_global_farm() -> Weight {
		(57_990_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(3 as Weight))
			.saturating_add(T::DbWeight::get().writes(3 as Weight))
	}
	fn create_yield_farm() -> Weight {
