...
impl NativeExecutionDispatch for BasiliskExecutorDispatch {
...
impl NativeExecutionDispatch for TestingBasiliskExecutorDispatch {
	type ExtendHostFunctions = frame_benchmarking::benchmarking::HostFunctions;
...
pub async fn start_node(
	...
	if parachain_config.chain_spec.is_testing_runtime() {
		start_node_impl::<_, testing_basilisk_runtime::RuntimeApi, TestingBasiliskExecutorDispatch, _>(
			parachain_config,
			polkadot_config,
			collator_options,
			para_id,
		...
		start_node_impl::<_, basilisk_runtime::RuntimeApi, BasiliskExecutorDispatch, _>(
			parachain_config,
			polkadot_config,
			collator_options,
			para_id,
